...
var Minilog = __webpack_require__(54);

var oldEnable = Minilog.enable,
    oldDisable = Minilog.disable,
    isChrome = (typeof navigator != 'undefined' && /chrome/i.test(navigator.userAgent)),
    console = __webpack_require__(58);
...
exports.backends = {
  ...
  browser: Minilog.defaultBackend,
  localStorage: __webpack_require__(63),
...
var microee = __webpack_require__(56);
...
logger.formatters = ['color', 'minilog'];
logger.color = __webpack_require__(59);
logger.minilog = __webpack_require__(61);
...
/* harmony import */ var _cozy_minilog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53);
...
class TemplateContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
  ...
  async fetch(context) {
    this.log('info', '🤖 fetch')
    throw new Error('fetch normal error')
