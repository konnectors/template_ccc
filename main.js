...
var _pTimeout = _interopRequireDefault(__webpack_require__(16));
...
var Minilog = __webpack_require__(50);

var oldEnable = Minilog.enable,
    oldDisable = Minilog.disable,
    isChrome = (typeof navigator != 'undefined' && /chrome/i.test(navigator.userAgent)),
    console = __webpack_require__(54);
...
exports.backends = {
  ...
  browser: Minilog.defaultBackend,
  localStorage: __webpack_require__(59),
  jQuery: __webpack_require__(60)
};
...
logger.formatters = ['color', 'minilog'];
logger.color = __webpack_require__(55);
logger.minilog = __webpack_require__(57);
...
/* harmony import */ var _cozy_minilog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49);
